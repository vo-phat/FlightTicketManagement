...
namespace GUI.Features.CabinClass.SubFeatures {
    public class CabinClassDetailControl : UserControl {
        ...
        private void BuildLayout() {
            ...
            int r = 0;
            grid.RowStyles.Add(new RowStyle(SizeType.AutoSize)); grid.Controls.Add(Key("Mã hạng ghế:"), 0, r); vCode = Val("vCode"); grid.Controls.Add(vCode, 1, r++);
        ...
        public void LoadCabin(string code, string name) {
            vCode.Text = code; 
            vName.Text = name;
        }
    }
